...
public class PanelJuego extends JPanel implements ActionListener{
	...
	// Guardamos en una variable la altura y el ancho de la pantalla
    ...
    ImageIcon bateria = new ImageIcon(img.getScaledInstance(Math.round((w*100)/1920), Math.round((h*270)/1080), Image.SCALE_DEFAULT));
    Image img2 = new ImageIcon("Assets/probeta.png").getImage();
    ImageIcon probeta = new ImageIcon(img2.getScaledInstance(Math.round((w*42)/1920), Math.round((h*146)/1080), Image.SCALE_DEFAULT));
    static Image imgT = new ImageIcon("Assets/t.png").getImage();
    static ImageIcon t = new ImageIcon(imgT.getScaledInstance(Math.round((w*20)/1920), Math.round((h*20)/1080), Image.SCALE_DEFAULT));
    Image iLupa = new ImageIcon("Assets/lupa.png").getImage();
    ImageIcon lupa = new ImageIcon(iLupa.getScaledInstance(Math.round((w*40)/1920), Math.round((h*40)/1080), Image.SCALE_DEFAULT));
    Image iCalavera = new ImageIcon("Assets/calavera.png").getImage();
    ImageIcon calavera = new ImageIcon(iCalavera.getScaledInstance(Math.round((w*50)/1920), Math.round((h*28)/1080), Image.SCALE_DEFAULT));
    Image iCurar = new ImageIcon("Assets/botonCurar.png").getImage();
    ImageIcon bCurar = new ImageIcon(iCurar.getScaledInstance(Math.round((w*385)/1920), Math.round((h*50)/1080), Image.SCALE_DEFAULT));
    Image iInvestigar = new ImageIcon("Assets/botonInvestigar.png").getImage();
    ImageIcon bInvestigar = new ImageIcon(iInvestigar.getScaledInstance(Math.round((w*50)/1920), Math.round((h*50)/1080), Image.SCALE_DEFAULT));
    Image iAjustes = new ImageIcon("Assets/Ajustes.png").getImage();
    ImageIcon bAjustes = new ImageIcon(iAjustes.getScaledInstance(Math.round((w*75)/1920), Math.round((h*75)/1080), Image.SCALE_DEFAULT));
    Image lFondoSalir = new ImageIcon("Assets/marcoSalir.png").getImage();
    ImageIcon bFondoSalir = new ImageIcon(lFondoSalir.getScaledInstance(Math.round((w*447)/1920), Math.round((h*175)/1080), Image.SCALE_DEFAULT));
    Image iGuardar = new ImageIcon("Assets/guardar.png").getImage();
    ImageIcon bGuardar = new ImageIcon(iGuardar.getScaledInstance(Math.round((w*75)/1920), Math.round((h*75)/1080), Image.SCALE_DEFAULT));
    Image iVolumen = new ImageIcon("Assets/volumen.png").getImage();
    ImageIcon bVolumen = new ImageIcon(iVolumen.getScaledInstance(Math.round((w*75)/1920), Math.round((h*75)/1080), Image.SCALE_DEFAULT));
    static Image iPub = new ImageIcon("Assets/mascarilla.png").getImage();
    static ImageIcon bPub = new ImageIcon(iPub.getScaledInstance(Math.round((w*150)/1920), Math.round((h*150)/1080), Image.SCALE_DEFAULT));
    Image bFondoGuardar = new ImageIcon("Assets/marcoGuardar.png").getImage();
    ImageIcon iFondoGuardar = new ImageIcon(bFondoGuardar.getScaledInstance(Math.round((w*400)/1920), Math.round((h*200)/1080), Image.SCALE_DEFAULT));
    Image iVictoria = new ImageIcon("Assets/victoria.png").getImage();
    ImageIcon lVictoria = new ImageIcon(iVictoria.getScaledInstance(Math.round((w*1000)/1920), Math.round((h*500)/1080), Image.SCALE_DEFAULT));
    Image iDerrota = new ImageIcon("Assets/derrota.png").getImage();
    ImageIcon lDerrota = new ImageIcon(iDerrota.getScaledInstance(Math.round((w*1000)/1920), Math.round((h*500)/1080), Image.SCALE_DEFAULT));
    Image iLab0 = new ImageIcon("Assets/Laboratorios/Laboratory0.png").getImage();
    ImageIcon lLab0 = new ImageIcon(iLab0.getScaledInstance(Math.round((w*150)/1920), Math.round((h*130)/1080), Image.SCALE_DEFAULT));
    Image iPub0 = new ImageIcon("Assets/mascarilla0.png").getImage();
    ImageIcon lPub0 = new ImageIcon(iPub0.getScaledInstance(Math.round((w*150)/1920), Math.round((h*130)/1080), Image.SCALE_DEFAULT));
    ImageIcon lFondoMenu = new ImageIcon(lFondoSalir.getScaledInstance(Math.round((w*250)/1920), Math.round((h*75)/1080), Image.SCALE_DEFAULT));
    ImageIcon lFondoVolumen = new ImageIcon(lFondoSalir.getScaledInstance(Math.round((w*350)/1920), Math.round((h*50)/1080), Image.SCALE_DEFAULT));
    Image mdi = new ImageIcon("Assets/mdi.png").getImage();
	ImageIcon mdii = new ImageIcon(mdi.getScaledInstance(Math.round((w*400)/1920), Math.round((h*441)/1080), Image.SCALE_DEFAULT));
	Image pR = new ImageIcon("Assets/pR.png").getImage();
	ImageIcon pRo = new ImageIcon(pR.getScaledInstance(Math.round((w*30)/1920), Math.round((h*30)/1080), Image.SCALE_DEFAULT));
	Image pV = new ImageIcon("Assets/pV.png").getImage();
	ImageIcon pVe = new ImageIcon(pV.getScaledInstance(Math.round((w*30)/1920), Math.round((h*30)/1080), Image.SCALE_DEFAULT));
	Image pZ = new ImageIcon("Assets/pZ.png").getImage();
	ImageIcon pZu = new ImageIcon(pZ.getScaledInstance(Math.round((w*30)/1920), Math.round((h*30)/1080), Image.SCALE_DEFAULT));
	Image pA = new ImageIcon("Assets/pAm.png").getImage();
	ImageIcon pAm = new ImageIcon(pA.getScaledInstance(Math.round((w*30)/1920), Math.round((h*30)/1080), Image.SCALE_DEFAULT));
	Image pT = new ImageIcon("Assets/pT.png").getImage();
	ImageIcon pTt = new ImageIcon(pT.getScaledInstance(Math.round((w*30)/1920), Math.round((h*30)/1080), Image.SCALE_DEFAULT));
	Image pB = new ImageIcon("Assets/pB.png").getImage();
	ImageIcon pBb = new ImageIcon(pB.getScaledInstance(Math.round((w*30)/1920), Math.round((h*30)/1080), Image.SCALE_DEFAULT));
	Image mL = new ImageIcon("Assets/iL.png").getImage();
	ImageIcon mll = new ImageIcon(mL.getScaledInstance(Math.round((w*60)/1920), Math.round((h*300)/1080), Image.SCALE_DEFAULT));
	Image mfl = new ImageIcon("Assets/mdi.png").getImage();
	ImageIcon mfll = new ImageIcon(mdi.getScaledInstance(Math.round((w*300)/1920), Math.round((h*350)/1080), Image.SCALE_DEFAULT));
	...
	static Thread hiloCarga;
	static Thread hiloContagio;
	static Thread hiloMuertos;
	static Thread hiloAm;
	static Thread hiloAz;
    static Thread hiloR;
    static Thread hiloV;
    static Thread hiloDatos;
    static Thread hiloBrote;
    static Thread hiloEvolucion;
	JButton curar;	
	JButton investigarAm;
	JButton investigarAz;
	JButton investigarR;
	JButton investigarV;
	JLabel bBateria;
	JLabel probetaAm;
	...
	private static ArrayList <JButton> ciudadesBoton = new ArrayList <JButton>();
	private static ArrayList <Ciudad> ciudadesLista = new ArrayList <Ciudad>();
	private static ArrayList <ImageIcon> iPais = new ArrayList <ImageIcon>();
	...
	PanelJuego(ArrayList<Musica> cancion){
		...
		// Leemos los parametros y definimos el volumen
		leer();
		definirVolumen();
		...
		continuar.setBounds(0, 0, w, h);
		continuar.setVisible(false);
		continuar.addActionListener(this);
		
		victoria = new JLabel(lVictoria);
		victoria.setBounds(Math.round((w*460)/1920), Math.round((h*290)/1080), Math.round((w*1000)/1920), Math.round((h*500)/1080));
		victoria.setVisible(false);
		
		derrota = new JLabel(lDerrota);
		derrota.setBounds(Math.round((w*460)/1920), Math.round((h*290)/1080), Math.round((w*1000)/1920), Math.round((h*500)/1080));
		...
		try {
			...
			for(int i = 0; i < 59; i++) {
				...
				ciudadesBoton.get(i).setBounds(Math.round((w*x)/1920), Math.round((h*y)/1080), 18, 18);
				ciudadesBoton.get(i).addActionListener(this);
				
				ciudadesLista.add(new Ciudad(c[0],Integer.parseInt(c[1]), colindantes));
				
				iPais.add(new ImageIcon(new ImageIcon("Assets/Banderas/" + ciudadesLista.get(i).getNombre() + ".png").getImage().getScaledInstance(Math.round((w*385)/1920), Math.round((h*190)/1080), Image.SCALE_DEFAULT)));
		...
		// Barra de energia
	    barra = new Barra(Math.round((w/2)-((45*w)/1920)), Math.round((h)-((237*h)/1080)), Math.round((w*90)/1920), Math.round((h*225)/1080));
		
	    // Botón para curar
		curar = new JButton(bCurar);
		curar.setBounds(0, Math.round((h)-((50*h)/1080)), Math.round((w*385)/1920), Math.round((h*50)/1080));
		...
		curar.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*50)/1080)));
		...
		bBateria.setBounds(Math.round((w/2)-((50*w)/1920)), Math.round((h)-((265*h)/1080)), Math.round((w*100)/1920), Math.round((h*270)/1080));
		
		// Barra, imagen y botón para investigar de cada vacuna, respectivamente
		barraAm = new Barra(255, 255, 0,cantidadInvestigacionVacunaAmarilla ,(1080*w)/1920, Math.round((h)-((222*h)/1080)), Math.round((w*30)/1920), Math.round((h*135)/1080));
		barraAm.setMaximum((int) (barraAm.getMaximum()*habilidad.getResistencia()));
		
		probetaAm = new JLabel(probeta);
		probetaAm.setBounds(Math.round((1075*w)/1920), Math.round((h)-((225*h)/1080)), Math.round((w*42)/1920), Math.round((h*146)/1080));
		
		investigarAm = new JButton(lupa);
		investigarAm.setBounds(Math.round((1072*w)/1920), Math.round((h)-((55*h)/1080)), Math.round((w*40)/1920), Math.round((h*40)/1080));
		investigarAm.addActionListener( new ActionListener() {
		      public void actionPerformed( ActionEvent evt ) {
		    	  synchronized( objetoAm ) {
		    		  if(barra.getValue()>=999) {investigaAm=true;}
					    objetoAm.notify();}}});
		...
		barraAz = new Barra(0, 100, 255,cantidadInvestigacionVacunaAzul,(1140*w)/1920, Math.round((h)-((222*h)/1080)), Math.round((w*30)/1920), Math.round((h*135)/1080));
		
		probetaAz = new JLabel(probeta);
		probetaAz.setBounds(Math.round((1135*w)/1920), Math.round((h)-((225*h)/1080)), Math.round((w*42)/1920), Math.round((h*146)/1080));
		
		investigarAz = new JButton(lupa);
		investigarAz.setBounds(Math.round((1134*w)/1920), Math.round((h)-((55*h)/1080)), Math.round((w*40)/1920), Math.round((h*40)/1080));
		...
		barraR = new Barra(255, 0, 0, cantidadInvestigacionVacunaRoja,(1200*w)/1920, Math.round((h)-((222*h)/1080)), Math.round((w*30)/1920), Math.round((h*135)/1080));
		
		probetaR = new JLabel(probeta);
		probetaR.setBounds(Math.round((1195*w)/1920), Math.round((h)-((225*h)/1080)), Math.round((w*42)/1920), Math.round((h*146)/1080));
		
		investigarR = new JButton(lupa);
		investigarR.setBounds(Math.round((1195*w)/1920), Math.round((h)-((h*55)/1080)), Math.round((w*40)/1920), Math.round((h*40)/1080));
		...
		barraV = new Barra(0, 255, 0,cantidadInvestigacionVacunaVerde,Math.round((1259*w)/1920), Math.round((h)-((222*h)/1080)), Math.round((w*30)/1920), Math.round((h*135)/1080));
		
		probetaV = new JLabel(probeta);
		probetaV.setBounds(Math.round((1253*w)/1920), Math.round((h)-((225*h)/1080)), Math.round((w*42)/1920), Math.round((h*146)/1080));
		
		investigarV = new JButton(lupa);
		investigarV.setBounds(Math.round((1254*w)/1920), Math.round((h)-((55*h)/1080)), Math.round((w*40)/1920), Math.round((h*40)/1080));
		...
		imagenPais.setBounds(Math.round((0*w)/1920), Math.round((840*h)/1080), Math.round((w*385)/1920), Math.round((h*190)/1080));
		imagenPais.setVisible(true);
		
		// Nombre de pais
		nombrePais = new JLabel();
		nombrePais.setBounds(Math.round((400*w)/1920), Math.round((840*h)/1080), Math.round((w*400)/1920), Math.round((h*50)/1080));
		nombrePais.setForeground(Color.white);
		nombrePais.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*30)/1080)));
		nombrePais.setVisible(true);
		
		// Población de pais
		poblacion = new JLabel();
		poblacion.setBounds(Math.round((650*w)/1920), Math.round((843*h)/1080), Math.round((w*200)/1920), Math.round((h*50)/1080));
		poblacion.setForeground(Color.white);
		poblacion.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*20)/1080)));
		poblacion.setVisible(true);
		poblacion.setHorizontalAlignment(JLabel.RIGHT);

		// Nivel de enfermedades de pais
		nivelRojo = new JLabel();
		nivelRojo.setBounds(Math.round((450*w)/1920), Math.round((880*h)/1080), Math.round((w*300)/1920), Math.round((h*50)/1080));
		nivelRojo.setForeground(Color.white);
		nivelRojo.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*20)/1080)));
		nivelRojo.setVisible(true);

		nivelAzul = new JLabel();
		nivelAzul.setBounds(Math.round((450*w)/1920), Math.round((920*h)/1080), Math.round((w*300)/1920), Math.round((h*50)/1080));
		nivelAzul.setForeground(Color.white);
		nivelAzul.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*20)/1080)));
		nivelAzul.setVisible(true);
		
		nivelAmarillo = new JLabel();
		nivelAmarillo.setBounds(Math.round((675*w)/1920), Math.round((880*h)/1080), Math.round((w*300)/1920), Math.round((h*50)/1080));
		nivelAmarillo.setForeground(Color.white);
		nivelAmarillo.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*20)/1080)));
		nivelAmarillo.setVisible(true);
		
		nivelVerde = new JLabel();
		nivelVerde.setBounds(Math.round((675*w)/1920), Math.round((920*h)/1080), Math.round((w*300)/1920), Math.round((h*50)/1080));
		nivelVerde.setForeground(Color.white);
		nivelVerde.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*20)/1080)));
		nivelVerde.setVisible(true);
		
		// Nivel de laboratorio
		laboratorios = new JLabel();
		laboratorios.setBounds(Math.round((450*w)/1920), Math.round((1000*h)/1080), Math.round((w*300)/1920), Math.round((h*50)/1080));
		laboratorios.setText("Laboratorios: 0");
		laboratorios.setForeground(Color.white);
		laboratorios.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*20)/1080)));
		laboratorios.setVisible(true);
		
		// Nivel de publicidad
		publicidades = new JLabel();
		publicidades.setBounds(Math.round((675*w)/1920), Math.round((1000*h)/1080), Math.round((w*300)/1920), Math.round((h*50)/1080));
		publicidades.setText("Publicidades: 0");
		publicidades.setForeground(Color.white);
		publicidades.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*20)/1080)));
		publicidades.setVisible(true);
		
		// Parámetro de poblacion muerta
		poblacionMundial = new JLabel();
		poblacionMundial.setBounds(Math.round((1625*w)/1920), Math.round((750*h)/1080), Math.round((w*225)/1920), Math.round((h*25)/1080));
		poblacionMundial.setForeground(Color.white);
		poblacionMundial.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*20)/1080)));
		...
		bll = new Boton(mll,Math.round((0*w)/1920), Math.round((450*h)/1080), Math.round((w*60)/1920), Math.round((h*300)/1080),true);
		bll.addActionListener(this);

		dll = new JLabel(mfll);
		dll.setBounds(Math.round((w*0)/1920), Math.round((h*470)/1080), Math.round((w*300)/1920), Math.round((h*350)/1080));
		dll.setVisible(false);
		
		dlam = new Label("Enfermedad Amarilla:",Math.round((w*15)/1920), Math.round((h*480)/1080), Math.round((w*400)/1920), Math.round((h*20)/1080),20);
		dlaz = new Label("Enfermedad Azul:",Math.round((w*15)/1920), Math.round((h*550)/1080), Math.round((w*400)/1920), Math.round((h*20)/1080),20);
		dlr = new Label("Enfermedad Roja:",Math.round((w*15)/1920), Math.round((h*620)/1080), Math.round((w*400)/1920), Math.round((h*20)/1080),20);
		dlv = new Label("Enfermedad Verde:",Math.round((w*15)/1920), Math.round((h*690)/1080), Math.round((w*400)/1920), Math.round((h*20)/1080),20);
		dlm = new Label("Estado Ciudades:",Math.round((w*15)/1920), Math.round((h*760)/1080), Math.round((w*400)/1920), Math.round((h*20)/1080),20);

		dltam = new Label("Nlv 1:             Nlv 2:             Nlv 3:",Math.round((w*15)/1920), Math.round((h*512)/1080), Math.round((w*500)/1920), Math.round((h*20)/1080),17);
		dltaz = new Label("Nlv 1:             Nlv 2:             Nlv 3:",Math.round((w*15)/1920), Math.round((h*582)/1080), Math.round((w*500)/1920), Math.round((h*20)/1080),17);
		dltr = new Label("Nlv 1:             Nlv 2:             Nlv 3:",Math.round((w*15)/1920), Math.round((h*652)/1080), Math.round((w*500)/1920), Math.round((h*20)/1080),17);
		dltv = new Label("Nlv 1:             Nlv 2:             Nlv 3:",Math.round((w*15)/1920), Math.round((h*722)/1080), Math.round((w*500)/1920), Math.round((h*20)/1080),17);
		dltm = new Label("Muerta:             Infectada 100%:",Math.round((w*15)/1920), Math.round((h*792)/1080), Math.round((w*500)/1920), Math.round((h*20)/1080),17);

		dlir1 = new Label(r1,Math.round((w*70)/1920), Math.round((h*650)/1080), Math.round((w*400)/1920), Math.round((h*20)/1080));
		dlir2 = new Label(r2,Math.round((w*160)/1920), Math.round((h*650)/1080), Math.round((w*400)/1920), Math.round((h*20)/1080));
		dlir3 = new Label(r3,Math.round((w*250)/1920), Math.round((h*650)/1080), Math.round((w*400)/1920), Math.round((h*20)/1080));

		dliam1 = new Label(am1,Math.round((w*70)/1920), Math.round((h*510)/1080), Math.round((w*500)/1920), Math.round((h*20)/1080));
		dliam2 = new Label(am2,Math.round((w*160)/1920), Math.round((h*510)/1080), Math.round((w*500)/1920), Math.round((h*20)/1080));
		dliam3 = new Label(am3,Math.round((w*250)/1920), Math.round((h*510)/1080), Math.round((w*500)/1920), Math.round((h*20)/1080));

		dliv1 = new Label(v1,Math.round((w*70)/1920), Math.round((h*720)/1080), Math.round((w*400)/1920), Math.round((h*20)/1080));
		dliv2 = new Label(v2,Math.round((w*160)/1920), Math.round((h*720)/1080), Math.round((w*400)/1920), Math.round((h*20)/1080));
		dliv3 = new Label(v3,Math.round((w*250)/1920), Math.round((h*720)/1080), Math.round((w*400)/1920), Math.round((h*20)/1080));
		
		dliaz1 = new Label(az1,Math.round((w*70)/1920), Math.round((h*580)/1080), Math.round((w*500)/1920), Math.round((h*20)/1080));
		dliaz2 = new Label(az2,Math.round((w*160)/1920), Math.round((h*580)/1080), Math.round((w*500)/1920), Math.round((h*20)/1080));
		dliaz3 = new Label(az3,Math.round((w*250)/1920), Math.round((h*580)/1080), Math.round((w*500)/1920), Math.round((h*20)/1080));
		
		dlim = new Label(n,Math.round((w*80)/1920), Math.round((h*785)/1080), Math.round((w*500)/1920), Math.round((h*20)/1080));
		dlit = new Label(t,Math.round((w*250)/1920), Math.round((h*785)/1080), Math.round((w*500)/1920), Math.round((h*20)/1080));

		// Demás información de los parámetros
		rojo = new JLabel(totalRojo + " / " + limiteEnfermedadRoja);
		rojo.setBounds(Math.round((1550*w)/1920), Math.round((700*h)/1080), Math.round((w*250)/1920), Math.round((h*25)/1080));
		rojo.setHorizontalAlignment(JLabel.RIGHT);
		rojo.setForeground(Color.white);
		rojo.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*20)/1080)));
		rojo.setVisible(true);
		
		azul = new JLabel(totalAzul + " / " + limiteEnfermedadAzul);
		azul.setBounds(Math.round((1550*w)/1920), Math.round((650*h)/1080), Math.round((w*250)/1920), Math.round((h*25)/1080));
		azul.setHorizontalAlignment(JLabel.RIGHT);
		azul.setForeground(Color.white);
		azul.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*20)/1080)));
		azul.setVisible(true);
		
		verde = new JLabel(totalVerde + " / " + limiteEnfermedadVerde);
		verde.setBounds(Math.round((1550*w)/1920), Math.round((600*h)/1080), Math.round((w*250)/1920), Math.round((h*25)/1080));
		verde.setVisible(true);
		verde.setHorizontalAlignment(JLabel.RIGHT);
		verde.setForeground(Color.white);
		verde.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*20)/1080)));
		
		amarillo = new JLabel(totalAmarillo + " / " + limiteEnfermedadAmarilla);
		amarillo.setBounds(Math.round((1550*w)/1920), Math.round((550*h)/1080), Math.round((w*250)/1920), Math.round((h*25)/1080));
		amarillo.setVisible(true);
		amarillo.setForeground(Color.white);
		amarillo.setHorizontalAlignment(JLabel.RIGHT);
		amarillo.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*20)/1080)));
		
		totales = new JLabel(totalEnfermedades +" / "+ limiteEnfermedad);
		totales.setBounds(Math.round((1550*w)/1920), Math.round((500*h)/1080), Math.round((w*250)/1920), Math.round((h*25)/1080));
		totales.setForeground(Color.white);
		totales.setHorizontalAlignment(JLabel.RIGHT);
		totales.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*20)/1080)));
		totales.setVisible(true);
		
		brotes = new JLabel(contadorBrotes+" / "+ limiteBrotes);
		brotes.setBounds(Math.round((1550*w)/1920), Math.round((450*h)/1080), Math.round((w*250)/1920), Math.round((h*25)/1080));
		brotes.setForeground(Color.white);
		brotes.setHorizontalAlignment(JLabel.RIGHT);
		brotes.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*20)/1080)));
		brotes.setVisible(true);
		 
		// Imagen de parámetros
		lCalavera = new JLabel(calavera);
		lCalavera.setBounds(Math.round((1850*w)/1920), Math.round((750*h)/1080), Math.round((w*50)/1920), Math.round((h*28)/1080));
		lCalavera.setVisible(true);
		
		md = new JLabel(mdii);
		md.setBounds(Math.round((w*1500)/1920), Math.round((h*150)/1080), Math.round((w*600)/1920), Math.round((h*900)/1080));
		md.setVisible(true);
		
		iVe = new JLabel(pVe);
		iVe.setBounds(Math.round((w*1550)/1920), Math.round((h*160)/1080), Math.round((w*600)/1920), Math.round((h*900)/1080));
		iVe.setVisible(true);
		
		iRo = new JLabel(pRo);
		iRo.setBounds(Math.round((w*1550)/1920), Math.round((h*260)/1080), Math.round((w*600)/1920), Math.round((h*900)/1080));
		iRo.setVisible(true);
		
		
		iAma = new JLabel(pAm);
		iAma.setBounds(Math.round((w*1550)/1920), Math.round((h*110)/1080), Math.round((w*600)/1920), Math.round((h*900)/1080));
		iAma.setVisible(true);
		
		iAzu = new JLabel(pZu);
		iAzu.setBounds(Math.round((w*1550)/1920), Math.round((h*210)/1080), Math.round((w*600)/1920), Math.round((h*900)/1080));
		iAzu.setVisible(true);
		
		iT = new JLabel(pTt);
		iT.setBounds(Math.round((w*1550)/1920), Math.round((h*60)/1080), Math.round((w*600)/1920), Math.round((h*900)/1080));
		iT.setVisible(true);
		
		iB = new JLabel(pBb);
		iB.setBounds(Math.round((w*1550)/1920), Math.round((h*10)/1080), Math.round((w*600)/1920), Math.round((h*900)/1080));
		iB.setVisible(true);
		
		// Imagen, nivel y botón de laboratorio
		laboratorio = new JLabel();
		laboratorio.setIcon(lLab0);
		laboratorio.setBounds(Math.round((1400*w)/1920), Math.round((h)-((220*h)/1080)), Math.round((w*150)/1920), Math.round((h*130)/1080));
		laboratorio.setVisible(true);
		
		nivelL = new JLabel();
		nivelL.setBounds(Math.round((1525*w)/1920), Math.round((h)-((230*h)/1080)), Math.round((w*40)/1920), Math.round((h*40)/1080));
		...
		mLab.setBounds(Math.round((1400*w)/1920), Math.round((h)-((50*h)/1080)), Math.round((w*150)/1920), Math.round((h*50)/1080));
		...
		publicidad.setBounds(Math.round((1600*w)/1920), Math.round((h)-((220*h)/1080)), Math.round((w*150)/1920), Math.round((h*150)/1080));
		publicidad.setVisible(true);
		
		nivelP = new JLabel();
		nivelP.setBounds(Math.round((1725*w)/1920), Math.round((h)-((230*h)/1080)), Math.round((w*40)/1920), Math.round((h*40)/1080));
		...
		mPub.setBounds(Math.round((1600*w)/1920), Math.round((h)-((50*h)/1080)), Math.round((w*150)/1920), Math.round((h*50)/1080));
		...
		salir.setBounds(Math.round((1845*w)/1920), 0, Math.round((w*80)/1920), Math.round((h*75)/1080));
		...
		lSalir.setBounds(Math.round((1485*w)/1920), Math.round((h*75)/1080), Math.round((w*447)/1920), Math.round((h*175)/1080));
		...
		pSalir.setBounds(Math.round((1520*w)/1920), Math.round((h*100)/1080), Math.round((w*405)/1920), Math.round((h*35)/1080));
		pSalir.setVisible(false);
		pSalir.setVerticalAlignment(Label.CENTER);
		pSalir.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*30)/1080)));
		pSalir.setForeground(Color.white);
		
		// Boton salir
		siSalir= new JButton("SI");
		siSalir.setBounds(Math.round((1505*w)/1920), Math.round((h*178)/1080), Math.round((w*200)/1920), Math.round((h*50)/1080));
		...
		noSalir.setBounds(Math.round((1707*w)/1920), Math.round((h*178)/1080), Math.round((w*200)/1920), Math.round((h*50)/1080));
		...
		guardar.setBounds(Math.round((1760*w)/1920), 0, Math.round((w*80)/1920), Math.round((h*75)/1080));
		...
		lGuardar.setBounds(Math.round((1520*w)/1920), Math.round((h*75)/1080), Math.round((w*400)/1920), Math.round((h*200)/1080));
		...
		partida1.setBounds(Math.round((1570*w)/1920), Math.round((h*90)/1080), Math.round((w*300)/1920), Math.round((h*50)/1080));
		...
		partida1.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*30)/1080)));
		...
		partida2.setBounds(Math.round((1570*w)/1920), Math.round((h*145)/1080), Math.round((w*300)/1920), Math.round((h*50)/1080));
		...
		partida2.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*30)/1080)));
		...
		partida3.setBounds(Math.round((1570*w)/1920), Math.round((h*200)/1080), Math.round((w*300)/1920), Math.round((h*50)/1080));
		...
		partida3.setFont(new FontUIResource ("Calibri" ,Font.PLAIN, Math.round((h*30)/1080)));
		...
		volumen.setBounds(Math.round((1675*w)/1920), 0, Math.round((w*80)/1920), Math.round((h*75)/1080));
		...
		lVolumen.setBounds(Math.round((1525*w)/1920), Math.round((h*75)/1080), Math.round((w*350)/1920), Math.round((h*50)/1080));
		...
		s1.setVisible(false);
		s1.setBounds(Math.round((1525*w)/1920), Math.round((h*75)/1080), Math.round((w*350)/1920), Math.round((h*50)/1080));
		s1.setVisible(false);
		s1.setOpaque(false);
		...
		texto.setBounds(Math.round((700*w)/1920), Math.round((700*h)/1080), Math.round((w*600)/1920), Math.round((h*40)/1080));
		...
		fondoMenu.setBounds(Math.round((1670*w)/1920), 0, Math.round((w*250)/1920), Math.round((h*75)/1080));
		fondoMenu.setVisible(true);
		
		// Barra de muertos totales
		muertes = new Barra(255, 0, 0, (int)(limiteMuertos), Math.round((1625*w)/1920), Math.round((750*h)/1080), Math.round((w*225)/1920), Math.round((h*25)/1080));
		...
		// Empezamos distintos hilos
		cancion.get(2).play();
		hiloDatos = new ThreadDatos();
		hiloDatos.start();
		
		hiloCarga = new ThreadCarga();
		hiloCarga.start();
		
		hiloContagio = new ThreadContagio();
		hiloContagio.start();
		
		hiloMuertos = new ThreadMuertes();
		hiloMuertos.start();
		
		hiloBrote = new ThreadBrote();
		hiloBrote.start();
		
		hiloEvolucion = new ThreadEvolucion();
		hiloEvolucion.start();

		// Actualizamos el nivel del laboratorio y publicidad
		if(PanelJugar.cargarPasar) {
			cargarDatos(PanelUsuario.con);
			nvlLab--;
			nvlUpLab();
			nvlPub--;
			nvlUpPub();
	...
	public static void nvlUpLab() {
		...
		if(nvlLab<12) {
			...
			ImageIcon lab = new ImageIcon(iLab.getScaledInstance(Math.round((w*150)/1920), Math.round((h*130)/1080), Image.SCALE_DEFAULT));
			...
			ImageIcon nvl = new ImageIcon(iNvl.getScaledInstance(Math.round((w*40)/1920), Math.round((h*40)/1080), Image.SCALE_DEFAULT));
			nivelL.setIcon(nvl);
	...
	class ThreadDatos extends Thread {
		...
		public void run() {
			...
			for(int i = 0; i < 2; i++) {
				...
				i--; 
				poblacion.setText(ciudadesLista.get(paisSeleccionado).getPoblacionMuerta() + " / " + ciudadesLista.get(paisSeleccionado).getPoblacionTotal());
				nivelRojo.setText("Nivel Rojo: " + ciudadesLista.get(paisSeleccionado).getRojo());
				nivelAzul.setText("Nivel Azul: " + ciudadesLista.get(paisSeleccionado).getAzul());
				nivelVerde.setText("Nivel Verde: " + ciudadesLista.get(paisSeleccionado).getVerde());
				nivelAmarillo.setText("Nivel Amarillo: " + ciudadesLista.get(paisSeleccionado).getAmarillo());
				rojo.setText(totalRojo + " / " + limiteEnfermedadRoja);
				azul.setText(totalAzul + " / " + limiteEnfermedadAzul);
				verde.setText(totalVerde + " / " + limiteEnfermedadVerde);
				amarillo.setText(totalAmarillo + " / " + limiteEnfermedadAmarilla);
				totales.setText(totalEnfermedades +" / "+ limiteEnfermedad);
				brotes.setText(contadorBrotes+" / "+ limiteBrotes);

				System.out.println(muertosTotales);
				System.out.println(limiteMuertos);


				if(muertosTotales >=  limiteMuertos || totalAmarillo == limiteEnfermedadAmarilla || totalAzul == limiteEnfermedadAzul || totalRojo == limiteEnfermedadRoja || totalVerde == limiteEnfermedadVerde || totalEnfermedades == limiteEnfermedad || limiteBrotes == contadorBrotes) {
				...
				} else if (investigadoAm && investigadoAz && investigadoR && investigadoV) {
					
					if(!PanelNuevaPartida.t && !PanelNuevaPartida.c) {puntos(PanelUsuario.con);}
					if (PanelJugar.cargarPasar) {borrarPartida(PanelUsuario.con);}
					continuar.setVisible(true);
		...
		public void run() {
			...
			for (int i = 0; i <= 5; i++) {
				...
				synchronized (objeto) {
					...
					if (cura && barra.getValue() >=250 && ciudadesLista.get(i).getCiudadMuerta() == 0) {barra.setValue(barra.getValue()-250); cura = false; ciudadesLista.get(paisSeleccionado).curar(investigadoAm, investigadoAz, investigadoR, investigadoV); nivel(paisSeleccionado);}
					
					if (investigaAm) {barra.setValue(0); hiloAm = new ThreadInvestigarAm(); hiloAm.start(); investigarAm.setVisible(false); investigarAm.setEnabled(false); 
						if(!investigadoAz) {investigarAz.setVisible(false); investigarAz.setEnabled(false);}
						if(!investigadoR) {investigarR.setVisible(false); investigarR.setEnabled(false);}
						if(!investigadoV) {investigarV.setVisible(false); investigarV.setEnabled(false);}}
					
					if (investigaAz) {barra.setValue(0); hiloAz = new ThreadInvestigarAz(); hiloAz.start(); investigarAz.setVisible(false); investigarAz.setEnabled(false);
						if(!investigadoAm) {investigarAm.setVisible(false); investigarAm.setEnabled(false);}
						if(!investigadoR) {investigarR.setVisible(false); investigarR.setEnabled(false);}
						if(!investigadoV) {investigarV.setVisible(false); investigarV.setEnabled(false);}}
					
					if (investigaR) {barra.setValue(0); hiloR = new ThreadInvestigarR(); hiloR.start(); investigarR.setVisible(false); investigarR.setEnabled(false);
						if(!investigadoAz) {investigarAz.setVisible(false); investigarAz.setEnabled(false);}
						if(!investigadoAm) {investigarAm.setVisible(false); investigarAm.setEnabled(false);}
						if(!investigadoV) {investigarV.setVisible(false); investigarV.setEnabled(false);}}
					
					if (investigaV) {barra.setValue(0); hiloV = new ThreadInvestigarV(); hiloV.start(); investigarV.setVisible(false); investigarV.setEnabled(false);
						if(!investigadoAz) {investigarAz.setVisible(false); investigarAz.setEnabled(false);}
						if(!investigadoR) {investigarR.setVisible(false); investigarR.setEnabled(false);}
						if(!investigadoAm) {investigarAm.setVisible(false); investigarAm.setEnabled(false);}}
					
						try {Thread.sleep(recargaEnergia);} catch (InterruptedException e) {}
					barra.setForeground(new Color(255, 255-(barra.getValue()/10), 00));
				}
	...
	class ThreadInvestigarAm extends Thread {
		...
		public void run() {
			...
			for (int i = 0; i <= 250; i++) {
				...
				try{if(barraAm.getValue()>30 || i>30) {barraAm.setValue(barraAm.getValue()+1);}}catch(Exception e) {}
				}
	...
	// Hilo para contagiar
	class ThreadContagio extends Thread {
		...
		public void run() {
			...
			for(int i = 0; i < 1; i++) {
				 ...
				 int rn = rd.nextInt(59);
				 
				if (ran == 0) {
					if (ciudadesLista.get(rn).getRojo() < 3) {ciudadesLista.get(rn).setRojo(ciudadesLista.get(rn).getRojo() + 1); nivel(rn);
					}else {brote(rn,1); contadorBrotes += 1;}
				}
				else if (ran == 1) {
					if (ciudadesLista.get(rn).getVerde() < 3) { ciudadesLista.get(rn).setVerde(ciudadesLista.get(rn).getVerde() + habilidad.getContagio()); nivel(rn);
					}else {brote(rn,2); contadorBrotes += 1;}
				}
				else if (ran == 2) {
					if (ciudadesLista.get(rn).getAmarillo() < 3) { ciudadesLista.get(rn).setAmarillo(ciudadesLista.get(rn).getAmarillo() + 1); nivel(rn);
					}else {brote(rn,3); contadorBrotes += 1;}
				}
				else if (ran == 3) {
					if (!evolucionV) {
						if (ciudadesLista.get(rn).getAzul() < 3) { ciudadesLista.get(rn).setAzul(ciudadesLista.get(rn).getAzul() + 1); nivel(rn);
						}else {brote(rn,4); contadorBrotes += 1;}
					}else {
						if (ciudadesLista.get(rn).getAzul() < 3) { ciudadesLista.get(rn).setAzul(ciudadesLista.get(rn).getAzul() + 1); nivel(rn);
						}else {brote(rn,4); contadorBrotes += habilidad.getContagio();}
					}
				}
				
				i --;
				try {Thread.sleep(frecuenciaContagio);} catch (InterruptedException e) {}
				if (parar) {i = 10;}
			}
		}
	...
	// Calcula cuantos brotes
	public void brote(int rn, int id) {
		
		ArrayList<String> colindantes = new ArrayList<>();

		colindantes = ciudadesLista.get(rn).getColindantes();
		
		for (int i = 0; i < colindantes.size(); i++) {
			
			for (int j = 0; j < colindantes.size(); j++) {
				
				if (colindantes.get(i).equals(ciudadesLista.get(j).getNombre())) {

					if (id == 1  && ciudadesLista.get(j).getRojo() < 3) { ciudadesLista.get(j).setRojo(ciudadesLista.get(j).getRojo() + 1); nivel(j);}
					else if (id == 2 && ciudadesLista.get(j).getAmarillo() < 3) { ciudadesLista.get(j).setAmarillo(ciudadesLista.get(j).getAmarillo() + 1); nivel(j);}
					else if (id == 3 && ciudadesLista.get(j).getRojo() < 3) { ciudadesLista.get(j).setAzul(ciudadesLista.get(j).getAzul() + 1); nivel(j);}
					else if (id == 4 && ciudadesLista.get(j).getVerde() < 3) { ciudadesLista.get(j).setVerde(ciudadesLista.get(j).getVerde() + habilidad.getContagio()); nivel(j);}
	...
	public void actionPerformed(ActionEvent e) {
		...
		}else if (e.getSource() == ciudadesBoton.get(0)) {
			paisSeleccionado = 0;
			actualizarMenu();
