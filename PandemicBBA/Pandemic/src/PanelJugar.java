...
public class PanelJugar extends JPanel implements ActionListener{
	...
	PanelJugar(){
		...
		titulo.setBounds((int) Math.round(Pantalla.width*0.05), (int) Math.round(Pantalla.height*0.1), Math.round((Pantalla.width*500)/1920), Math.round((Pantalla.height*100)/1080));
		...
		nueva = new Boton("NUEVA PARTIDA", (int) Math.round(Pantalla.width*0.04), (int) Math.round(Pantalla.height*0.375), Math.round((Pantalla.width*450)/1920), Math.round((Pantalla.height*50)/1080));
		nueva.addActionListener(this);
		nueva.MouseListener();
		
		// Creamos el boton de cargar partida
		cargar = new Boton("CARGAR PARTIDA", (int) Math.round(Pantalla.width*0.04), (int) Math.round(Pantalla.height*0.450), Math.round((Pantalla.width*450)/1920), Math.round((Pantalla.height*50)/1080));
		cargar.addActionListener(this);
		cargar.MouseListener();
		
		// Creamos el boton de ajustes
		ajustes = new Boton("VOLUMEN", (int) Math.round(Pantalla.width*0.04), (int) Math.round(Pantalla.height*0.525), Math.round((Pantalla.width*425)/1920), Math.round((Pantalla.height*50)/1080));
		ajustes.addActionListener(this);
		ajustes.MouseListener();
		
		// Creamos el boton de ranking
		ranking = new Boton("RANKING", (int) Math.round(Pantalla.width*0.04), (int) Math.round(Pantalla.height*0.600), Math.round((Pantalla.width*425)/1920), Math.round((Pantalla.height*50)/1080));
		ranking.addActionListener(this);
		ranking.MouseListener();
		
		// Creamos el boton de creditos
		creditos = new Boton("CRÉDITOS", (int) Math.round(Pantalla.width*0.04), (int) Math.round(Pantalla.height*0.675), Math.round((Pantalla.width*425)/1920), Math.round((Pantalla.height*50)/1080));
		creditos.addActionListener(this);
		creditos.MouseListener();
		
		// Creamos el boton de reglas
		reglas = new Boton("REGLAS", (int) Math.round(Pantalla.width*0.04), (int) Math.round(Pantalla.height*0.75), Math.round((Pantalla.width*425)/1920), Math.round((Pantalla.height*50)/1080));
		reglas.addActionListener(this);
		reglas.MouseListener();
		
		// Creamos el boton para salir
		salir = new Boton("SALIR", (int) Math.round(Pantalla.width*0.04), (int) Math.round(Pantalla.height*0.825), Math.round((Pantalla.width*425)/1920), Math.round((Pantalla.height*50)/1080));
