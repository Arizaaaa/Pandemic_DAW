...
public class PanelAjustes extends JPanel implements ActionListener{
	...
	PanelAjustes(){
		...
		atras = new Boton("ATRÁS", (int) Math.round(Pantalla.width*0.04), (int) Math.round(Pantalla.height*0.75), Math.round((Pantalla.width*425)/1920), Math.round((Pantalla.height*75)/1080));
